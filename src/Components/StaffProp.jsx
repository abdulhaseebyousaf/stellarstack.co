...
import Arrowright from '../assets/logo/RightChevron.svg'
export default function StaffProp({text, secondtext, description, thirdtext, learn}) {
  return (
    ...
    <Link className='flex items-center gap-2 rounded-md text-white bg-[#204285] hover:bg-[#163369] hover:shadow-lg transform hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer w-max text-lg font-medium px-9 py-2.5' to="/our-staff">
    <span>{learn}</span>
