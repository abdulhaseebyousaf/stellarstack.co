  ...
  return (
    ...
    <div className='flex flex-col lg:flex-row-reverse max-lg:mb-16 gap-6 md:gap-20 py-0 lg:py-24 2xl:py-36  lg:items-center' >
        ...
        <div className='pt-12 md:pt-[102px]'>
            <Link to="/" className='flex items-center gap-2 rounded-md text-white bg-[#204285] hover:bg-[#163369] hover:shadow-lg transform hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer w-max text-xl md:text-2xl font-medium px-3.5 py-2 md:py-3'><span>Learn More</span>
            <img src={Logo} alt="" />
            </Link>
        </div>
        </div>
