...
export default function OurCulture() {
  return (
    <div>
      ...
      <div>
        <h1 className="text-5xl lg:text-[64px] font-bold 2xl:leading-24 tracking-[-1.5px] text-[#231F20]">
          Our <span className="text-[#204285]">Culture</span>
        </h1>
        <p className="pt-5 pb-14 lg:w-[455px] text-2xl text-[#231F20]">
        ...
        <a
          target="_blank"
           href="#"
        >
          <button className="flex items-center gap-2 rounded-md text-white bg-[#204285] hover:bg-[#163369] hover:shadow-lg transform hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer w-max text-lg font-medium px-7 py-3">
            <span>Get in Touch</span>
          </button>
        </a>
      </div>
      <div className="lg:max-w-[700px] 2xl:max-w-[824px] max-lg:mt-12">
        <p className="text-lg md:text-xl 2xl:text-2xl font-normal text-[#4B5563] mb-4">
        ...
        <a
          className="text-lg md:text-xl text-[#204285] font-medium inline-flex items-center group"
          href="/about-us"
        >
          See more
