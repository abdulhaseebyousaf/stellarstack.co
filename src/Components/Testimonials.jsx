 ...
 const swiperRef = useRef(null);
  ...
  const handlerClose = (id) => {
    setisShowText((prev) => (prev === id ? null : id));
    // DOM update ke baad Swiper ki height recalibrate
    setTimeout(() => swiperRef.current?.updateAutoHeight(300), 0);
  };
  ...
  useEffect(() => {
    ...
    className={`italic text-xl font-normal inline leading-relaxed text-[#4B5563] ${
  ...
  >
    ...
    {items.textToHide && (
      <button
        className="text-[#204285] hover:underline inline cursor-pointer"
