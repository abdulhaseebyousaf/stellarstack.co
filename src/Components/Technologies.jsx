...
<div className='max-w-[1810px] md:min-h-[660px] sm:min-h-[640px] min-h-[580px] sm:gap-0 gap-7 mx-auto w-full px-6 py-12 flex lg:flex-row flex-col justify-between lg:items-center' >
