      ...
      <div className='flex flex-col sm:flex-row justify-between sm:items-center gap-6'>
        ...
        <div className='pl-2'>
          ...
          <div className='pr-2 pt-2.5 flex gap-4 text-blue-500 text-lg'>
            ...
            <a href="https://www.linkedin.com/company/stellar-stack/posts/?feedView=all">
            <img  src={Image} alt="" />
            </a>
            <a href="https://www.facebook.com/stellarstackltd?rdid=U7CaOzaYldUEstK5&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F19VVoiZjSt%2F#">
            <img  src={Image1} alt="" />
            </a>
            <a href="https://github.com/StellarStack">
            <img  src={Image2} alt="" />
            </a>
            <a href="https://www.instagram.com/p/DLFEWJ5I6bd/?igsh=MWZvbHBxbThldWVrOQ%3D%3D">
            <img  src={Image3} alt="" />
          </a>
          </div>
        </div>
