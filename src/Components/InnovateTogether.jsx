...
import CaseStudyImgsecond from '../assets/logo/pictures/CaseStudyImg2.webp'
import CaseStudyImgthree from '../assets/logo/pictures/CaseStudyImgthree.webp'
import CaseStudyImgfour from '../assets/logo/pictures/CaseStudyImgfour.webp'
import CaseStudyImgfifth from '../assets/logo/pictures/CaseStudyImgfifth.webp'
import CaseStudyImgsixth from '../assets/logo/pictures/CaseStudyImgsixth.webp'
          ...
          {Data.map((items, index) => (
            <div key={index} className="flex items-center  flex-col mb-4 ">
                <img
                  ...
                  src={items.image}
                  />
                <span className={`text-xs sm:text-base md:text-lg  text-[#71717A]  lg:text-xl 2xl:text-2xl font-semibold  text-center ${
                activeIndex === index ? "text-[#083588]" : "text-[#71717A]"
              }`}>
...
autoplay={{
      ...
      >
        ...
        <img key={secondindex} src={seconditem.firstimage} alt="" />
        <h3 className="text-2xl md:text-3xl xl:text-4xl 2xl:text-5xl font-medium text-center mt-4 text-[#282828]">{seconditem.secondheading}</h3>
        <p className="pb-14 text-lg md:text-xl lg:text-2xl 2xl:text-3xl text-center text-[#71717A] mt-2">{seconditem.secondtext}</p>
        </div>
        </SwiperSlide>
        ))}
        </Swiper>
