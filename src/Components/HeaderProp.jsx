...
<a href="/our-services" className='hover:bg-gray-100  cursor-pointer px-4 py-3 m-0 transition-colors duration-200'>{our}</a>
<a href="/our-staff" className='hover:bg-gray-100 cursor-pointer px-4 py-3 m-0 transition-colors duration-200'>{Staff}</a>
<a href="/how-we-hire" className='hover:bg-gray-100 cursor-pointer px-4 py-3 m-0 transition-colors duration-200'>{How}</a>
</div>
)}
