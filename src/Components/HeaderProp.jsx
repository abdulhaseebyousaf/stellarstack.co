...
<div className='absolute tot-full left-0 w-60 z-50 hidden bg-white shadow-md shadow-black/15 rounded-sm '>
...
<button type="button" className='text-base cursor-pointer font-normal text-[#204285] hover:text-blue-600 transition-colors duration-200'>{service}</button>
      </div>
