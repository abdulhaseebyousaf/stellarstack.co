  ...
  return (
    <div className="bg-[#f9fafc]">
      <div className="max-w-[1810px] mx-auto grid xl:grid-cols-2 gap-12 xl:gap-6 xl:place-items-center px-6 py-16 md:py-24 2xl:py-36">
        <div>
          <h1 class="text-4xl md:text-5xl 2xl:text-[65px] 2xl:leading-[70px] font-bold tracking-[-1.5px] text-[#231F20]">
            How Our <span class="text-[#204285]">Staff Augmentation</span>{" "}
            Solutions Work
          </h1>
        ...
        <div className="max-w-[1810px] mx-auto grid sm:grid-cols-2 gap-5 2xl:gap-10">
          <div className="flex flex-col justify-between pt-12 2xl:pt-20 rounded-3xl text-center bg-[#CDD4DF]">
            <h3 class="mb-16 2xl:mb-20 px-3 text-3xl font-semibold text-[#231F20]">
              Every Step Matters Towards the <br /> <br />{" "}
              <span class="text-[#204285]">Perfect Fit</span>
            </h3>
            <div class="min-h-[250px] h-full px-3 flex items-center sm:text-2xl font-normal rounded-t-[55px] rounded-b-3xl text-white bg-[#204285]">
          ...
          <div class="flex flex-col gap-[30px]">
            <div class="relative group h-[352px] bg-[#CDD4DF] rounded-3xl overflow-hidden transition-all duration-300">
              <div class="absolute inset-0 flex items-center justify-center transition-opacity duration-500 group-hover:opacity-0 z-10">
                <h3 class="text-3xl xl:text-2xl 2xl:text-3xl font-semibold text-center text-[#204285]">
                  The Result?
                </h3>
              </div>
              <div class="absolute bottom-0 left-0 right-0 translate-y-[330px] group-hover:translate-y-0 transition-transform duration-500 z-10">
                <div class="bg-[#204285] text-white text-center px-3 py-4 2xl:py-8 rounded-t-[55px] rounded-b-3xl h-[352px] flex items-center justify-center">
                  <p class="text-base lg:text-xl 2xl:text-2xl font-normal">
